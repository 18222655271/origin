<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:60:"D:\phpstudy_pro\WWW\faas\addons\qrcode\view\index\index.html";i:1591881415;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="background" placeholder="" class="form-control" value="#ffffff">
                                </div>
                                <div class="form-group">
