...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-type_id" data-rule="required" data-source="ykquest/survey_type/index" class="form-control selectpage" name="row[type_id]" type="text" value="<?php echo htmlentities($row['type_id']); ?>">
        </div>
    </div>
