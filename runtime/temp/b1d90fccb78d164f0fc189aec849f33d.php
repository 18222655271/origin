<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:56:"D:\phpstudy_pro\WWW\faas\addons\wwh\view\index\join.html";i:1611641096;s:58:"D:\phpstudy_pro\WWW\faas\addons\wwh\view\index\header.html";i:1620800281;s:58:"D:\phpstudy_pro\WWW\faas\addons\wwh\view\index\footer.html";i:1611641096;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <title>加入我们_<?php echo $config['site_name']; ?></title>
        ...
        <div class="main container">
            <div class="sub-nav">
                <div class="items">
                    ...
                    <a class="active" href="<?php echo addon_url('wwh/index/join'); ?>">加入我们</a><i></i>
...
<div id="join">
    <div class="container">
        <div class="join-box">
            ...
            <form method="post" class="join-select">
                ...
                <div class="select">
                    <select name="branch" id="branch">
                        ...
                        <option value="<?php echo $vo['dept']; ?>"><?php echo $vo['dept']; ?></option>
                ...
                <div class="select">
                    <select name="address" id="address">
                        ...
                        <?php if(is_array($addr) || $addr instanceof \think\Collection || $addr instanceof \think\Paginator): $i = 0; $__LIST__ = $addr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                        <option value="<?php echo $vo['addr']; ?>"><?php echo $vo['addr']; ?></option>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </div>
            ...
            <!--<div class="num-box">当前条件下共有<span><?php echo $total; ?></span>个岗位</div>-->
            <ul class="join-list">
                <div id="shuju">
                ...
                <li>
                    <div class="recruit-top">
                        <div>
                            职位： <span><?php echo $vo['name']; ?></span>
                        </div>
                        <div>
                            部门：<span><?php echo $vo['dept']; ?></span>
                        </div>
                        <div>
                            工作地点：<span><?php echo $vo['addr']; ?></span>
                        </div>
                        <div>
                            招聘人数：<span><?php echo $vo['num']; ?></span>
                        </div>
                        <div>
                            发布时间： <span><?php echo $vo['time']; ?></span>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    $(function(){
        $("button").click(function(){
            ...
            $.ajax({
                type:"post",
                url:"<?php echo addon_url('wwh/index/join'); ?>",
