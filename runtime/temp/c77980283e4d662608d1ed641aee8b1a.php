<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:75:"D:\phpstudy_pro\WWW\faas\public/../application/admin\view\addon\config.html";i:1617358420;s:67:"D:\phpstudy_pro\WWW\faas\application\admin\view\layout\default.html";i:1617358420;s:64:"D:\phpstudy_pro\WWW\faas\application\admin\view\common\meta.html";i:1617358420;s:66:"D:\phpstudy_pro\WWW\faas\application\admin\view\common\script.html";i:1617358420;}*/ ?>
<!DOCTYPE html>
                ...
                <div class="row">
                    <div class="col-sm-8 col-xs-12">
                        ...
                        <div class="input-group">
                            <input <?php echo $item['extend']; ?> id="c-<?php echo $item['name']; ?>" class="form-control" size="50" name="row[<?php echo $item['name']; ?>]" type="text" value="<?php echo htmlentities($item['value']); ?>" data-tip="<?php echo $item['tip']; ?>" data-rule="<?php echo $item['rule']; ?>">
                        ...
                        <div class="input-group">
                            <input <?php echo $item['extend']; ?> id="c-<?php echo $item['name']; ?>" class="form-control" size="50" name="row[<?php echo $item['name']; ?>]" type="text" value="<?php echo htmlentities($item['value']); ?>" data-tip="<?php echo $item['tip']; ?>" data-rule="<?php echo $item['rule']; ?>">
                            <div class="input-group-addon no-border no-padding">
                                <span><button type="button" id="faupload-<?php echo $item['name']; ?>" class="btn btn-danger faupload" data-input-id="c-<?php echo $item['name']; ?>" data-multiple="<?php echo $item['type']=='file'?'false':'true'; ?>" data-preview-id="p-<?php echo $item['name']; ?>"><i class="fa fa-upload"></i> <?php echo __('Upload'); ?></button></span>
