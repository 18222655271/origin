...
class Newscategory extends Backend
{
    ...
    /**
     * WwhNewscategory模型对象
     * @var \app\admin\model\wwh\Newscategory
     */
    ...
    {
        parent::_initialize();
        $this->model = model('\app\admin\model\wwh\Newscategory');

        $newsCategoryList = collection($this->model->select())->toArray();
