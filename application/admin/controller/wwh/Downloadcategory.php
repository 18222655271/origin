 ...
 * @icon fa fa-circle-o
 */
class Downloadcategory extends Backend
{

    /**
     * WwhDownloadcategory模型对象
     * @var \app\admin\model\wwh\Downloadcategory
     */
    ...
    {
        parent::_initialize();
        $this->model = model('\app\admin\model\wwh\Downloadcategory');

        $downloadCategoryList = collection($this->model->select())->toArray();
