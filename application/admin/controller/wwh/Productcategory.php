...
class Productcategory extends Backend
{
    ...
    /**
     * WwhProductcategory模型对象
     * @var \app\admin\model\wwh\Productcategory
     */
    ...
    {
        parent::_initialize();
        $this->model = model('\app\admin\model\wwh\Productcategory');

        $productCategoryList = collection($this->model->select())->toArray();
