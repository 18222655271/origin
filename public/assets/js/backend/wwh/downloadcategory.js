define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'wwh/downloadcategory/index',
                    add_url: 'wwh/downloadcategory/add',
                    edit_url: 'wwh/downloadcategory/edit',
                    del_url: 'wwh/downloadcategory/del',
                    multi_url: 'wwh/downloadcategory/multi',
                    table: 'wwh_downloadcategory',
                }
            });
