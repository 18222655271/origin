...
(2, 'user', 'basic', '会员配置', '', 'array', '{\"nickname\":\"Shopro-\",\"avatar\":\"http://file.shopro.top/uploads/20200410/default-avatar.png\",\"group_id\":\"1\",\"money\":\"\",\"score\":\"\"}', NULL, '', ''),
...
ALTER TABLE `__PREFIX__shopro_user_wallet_apply` ADD COLUMN `apply_sn` varchar(60) NOT NULL COMMENT '提现单号' AFTER `user_id`;
